...
return 'Decompiler coming soon! - Wendo'
end;
...
local pcall = pcall; -- new user syndrome
...
Src = 'Server scripts can't be decompiled.';
end;
else
Src = '';
end;
...
Print(string.format('Took %d second(s), please check your workspace folder', tick() - Timer));
end;
